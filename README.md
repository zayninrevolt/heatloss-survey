...
Technical U-value entry is replaced with a small set of practical construction choices. The wall list includes two DHDG open-cavity presets for a brick outer leaf, air gap, aerated-block inner leaf and 13mm plaster: 100mm inner block at U=0.87 and 125mm inner block at U=0.77. It also includes single brick or stud and plasterboard internal walls, RdSAP Table 24 external-window and roof-window choices, and plasterboard loft ceilings with no insulation or 50mm, 100mm or 200mm insulation. A small number of worked DHDG reference presets are included for an uninsulated solid ground floor (U=0.85) and a flat roof with 200mm insulation (U=0.17). External doors follow RdSAP 10 Table 26: 3.0 W/m²K in age bands A to J, 2.0 in K, 1.8 in L for England, Wales and Northern Ireland (1.6 in Scotland), 1.4 in M, and 1.4 to an unheated corridor or stairwell. A door only counts as insulated with documentary evidence of its U-value, and a door with 60% or more glazing is recorded as a window rather than as a door. Window and roof-window selections give the documented whole-opening U-value, including PVC or wood frame, glazing gap and installation period. Property-wide defaults apply external wall, internal wall and window choices. Floor, ceiling or loft construction and ventilation devices must be selected inside each room so different floors and room conditions can be treated correctly.
